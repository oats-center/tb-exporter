...
pipenv run transfer --username $source_username --password $source_password --url $source_url --device $source_device_id --post_url $sink_url --device_token $sink_device_token --key soil_moisture_gwc --type float
pipenv run transfer --username $source_username --password $source_password --url $source_url --device $source_device_id --post_url $sink_url --device_token $sink_device_token --key soil_moisture_hz --type int
pipenv run transfer --username $source_username --password $source_password --url $source_url --device $source_device_id --post_url $sink_url --device_token $sink_device_token --key soil_temp0_c --type float
