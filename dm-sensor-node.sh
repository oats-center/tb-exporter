...
pipenv run transfer --username $source_username --password $source_password --url $source_url --device $source_device_id --post_url $sink_url --device_token $sink_device_token --key analog_in_1 --type float
pipenv run transfer --username $source_username --password $source_password --url $source_url --device $source_device_id --post_url $sink_url --device_token $sink_device_token --key input1_pulse_count --type int
pipenv run transfer --username $source_username --password $source_password --url $source_url --device $source_device_id --post_url $sink_url --device_token $sink_device_token --key internal_temp --type float
pipenv run transfer --username $source_username --password $source_password --url $source_url --device $source_device_id --post_url $sink_url --device_token $sink_device_token --key alert_input --type int
pipenv run transfer --username $source_username --password $source_password --url $source_url --device $source_device_id --post_url $sink_url --device_token $sink_device_token --key current_io_state --type int
pipenv run transfer --username $source_username --password $source_password --url $source_url --device $source_device_id --post_url $sink_url --device_token $sink_device_token --key input2_pulse_count --type int
...
pipenv run transfer --username $source_username --password $source_password --url $source_url --device $source_device_id --post_url $sink_url --device_token $sink_device_token --key lat --type int 
pipenv run transfer --username $source_username --password $source_password --url $source_url --device $source_device_id --post_url $sink_url --device_token $sink_device_token --key lng --type int 
